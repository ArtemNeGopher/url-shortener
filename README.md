...
Данный проект в конце работы вам надо будет развернуть на railway. Это не инструмент разработчика (скорее вайбкодера), но вы сможете полностью с 0 сами настроить деплой приложений, настроить общение сервисов.
